...
A Telegram bot that polls for voice messages and transcribes them locally using mlx-whisper (Apple Silicon). Transcriptions are saved as Markdown files with YAML frontmatter.
